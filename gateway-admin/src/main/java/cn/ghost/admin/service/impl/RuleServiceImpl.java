...
import cn.ghost.admin.listener.event.RuleAddEvent;
import cn.ghost.admin.listener.event.RuleDeleteEvent;
import cn.ghost.admin.mapper.AppInstanceMapper;
import cn.ghost.admin.mapper.AppMapper;
import cn.ghost.admin.mapper.RouteRuleMapper;
...
import cn.ghost.admin.transfer.AppRuleVOTransfer;
import cn.ghost.admin.transfer.RuleVOTransfer;
...
public class RuleServiceImpl implements RuleService {
    ...
    private void checkRule(RuleDTO ruleDTO) {
        ...
        if (cn.ghost.admin.common.constants.MatchObjectEnum.DEFAULT.getCode().equals(ruleDTO.getMatchObject())) {
    ...
    private String buildMatchStr(RuleVO ruleVO) {
        if (cn.ghost.admin.common.constants.MatchObjectEnum.DEFAULT.getCode().equals(ruleVO.getMatchObject())){
            return ruleVO.getMatchObject();
        }else {
            StringBuilder sb = new StringBuilder();
            sb.append("["+ruleVO.getMatchKey()+"] ");
            sb.append(cn.ghost.admin.common.constants.MatchMethodEnum.getByCode(ruleVO.getMatchMethod()).getDesc());
